...
def svm_rbf(X_train=None, X_val=None, X_test=None,
    ...
    """
        Available hyperparameter for SVC:
            ...
            gamma: default='scale'      # Options: ‘scale’, ‘auto’
                - if gamma='scale' (default) is passed then it uses gamma = 1 / (n_features * X.var()),
    ...
    param_space = {
        ...
        'gamma': Categorical(['scale', 'auto', 0.01, 1, 10])
    }
